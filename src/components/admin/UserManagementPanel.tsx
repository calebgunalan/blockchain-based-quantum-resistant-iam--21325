...
import { Users, Plus, Edit, Trash2, Shield, Mail, Calendar, Activity, Eye, EyeOff } from 'lucide-react';
    ...
    try {
      ...
      if (newUser.role !== 'user') {
        ...
        if (existingRole) {
          ...
          if (updateRoleError) {
            console.error('Role assignment error:', updateRoleError);
            throw new Error('Database error saving new user role');
          }
        } else {
